...
if(isset($_POST["import"])){
    ...
    if($_FILES["file"]["size"] > 0){
        ...
        while(($column = fgetcsv($file, 10000, ",")) !== FALSE){
            ...
            $sqlCheck = "SELECT COUNT(*) as count FROM ianuarie WHERE eveniment_ian = '" . $column[0] . "' AND clicks_ian  = '" . $column[1] . "' AND pagini_ian  = '" . $column[2] . "' AND durata_ian  = '" . $column[3] . "' AND dispozitiv_ian  = '" . $column[4] . "' AND rezolutie_ian  = '" . $column[5] . "' AND locatie_ian  = '" . $column[6] . "'";
            ...
            if ($rowCheck['count'] == 0) {
                ...
                $sqlInsert = "Insert into ianuarie ( eveniment_ian , clicks_ian , pagini_ian , durata_ian , dispozitiv_ian , rezolutie_ian , locatie_ian ) values ('" . $column[0] . "', '" . $column[1] . "', '" . $column[2] . "', '" . $column[3] . "', '" . $column[4] . "', '" . $column[5] . "', '" . $column[6] . "')";
...
<body id="ianuarie">
    ...
    <!-- main -->
        <main>
            <h1 class="title">Timpul pe site al utilizatorilor în luna ianuarie</h1>
     ...
     <!-- content -->
        ...
        <?php
    // display upload data
        $sqlSelect = "SELECT * from ianuarie";
        ...
        if(mysqli_num_rows($result)>0){
            ...
            <table>
                ...
                <tbody>
                    <tr>
                        <td class="narrow"><?php echo $row['nr_util_ian'];?></td>
                        <td class="narrow"><?php echo $row['eveniment_ian'];?></td>
                        <td class="narrow"><?php echo $row['clicks_ian'];?></td>
                        <td class="narrow"><?php echo $row['pagini_ian'];?></td>
                        <td class="narrow"><?php echo $row['durata_ian'];?></td>
                        <td class="narrow"><?php echo $row['dispozitiv_ian'];?></td>
                        <td class="narrow"><?php echo $row['rezolutie_ian'];?></td>
                        <td class="narrow"><?php echo $row['locatie_ian'];?></td>
                    </tr>
                </tbody>
        ...
        ?>
            ...
            <div id="custom-text-section">
                <h2>Interpretarea rezultatelor - Ianuarie</h2>
                <textarea id="custom-text-ianuarie" rows="4" cols="50"></textarea>
                <div class="btn-txt"> 
