...
if(isset($_POST["import"])){
    ...
    if($_FILES["file"]["size"] > 0){
        ...
        while(($column = fgetcsv($file, 10000, ",")) !== FALSE){
            ...
            $sqlCheck = "SELECT COUNT(*) as count FROM mai WHERE eveniment_mai = '" . $column[0] . "' AND clicks_mai = '" . $column[1] . "' AND pagini_mai = '" . $column[2] . "' AND durata_mai = '" . $column[3] . "' AND dispozitiv_mai = '" . $column[4] . "' AND rezolutie_mai = '" . $column[5] . "' AND locatie_mai = '" . $column[6] . "'";
            ...
            if ($rowCheck['count'] == 0) {
                ...
                $sqlInsert = "Insert into mai ( eveniment_mai, clicks_mai, pagini_mai, durata_mai, dispozitiv_mai, rezolutie_mai, locatie_mai) values ('" . $column[0] . "', '" . $column[1] . "', '" . $column[2] . "', '" . $column[3] . "', '" . $column[4] . "', '" . $column[5] . "', '" . $column[6] . "')";
...
<body id="mai">>
    ...
    <!-- main -->
        <main>
            <h1 class="title">Timpul pe site al utilizatorilor în luna mai</h1>
    ...
    // display upload data
        ...
        if(mysqli_num_rows($result)>0){
            ...
            <table>
                ...
                <tbody>
                    <tr>
                        <td class="narrow"><?php echo $row['nr_util_mai'];?></td>
                        <td class="narrow"><?php echo $row['eveniment_mai'];?></td>
                        <td class="narrow"><?php echo $row['clicks_mai'];?></td>
                        <td class="narrow"><?php echo $row['pagini_mai'];?></td>
                        <td class="narrow"><?php echo $row['durata_mai'];?></td>
                        <td class="narrow"><?php echo $row['dispozitiv_mai'];?></td>
                        <td class="narrow"><?php echo $row['rezolutie_mai'];?></td>
                        <td class="narrow"><?php echo $row['locatie_mai'];?></td>
                    </tr>
                </tbody>
        ...
        ?>
            ...
            <div id="custom-text-section">
                <h2>Interpretarea rezultatelor - Mai</h2>
                <textarea id="custom-text-mai" rows="4" cols="50"></textarea>
                <div class="btn-txt"> 
