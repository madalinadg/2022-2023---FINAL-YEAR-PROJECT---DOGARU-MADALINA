...
if(isset($_POST["import"])){
    ...
    if($_FILES["file"]["size"] > 0){
        ...
        while(($column = fgetcsv($file, 10000, ",")) !== FALSE){
            ...
            $sqlCheck = "SELECT COUNT(*) as count FROM iunie WHERE eveniment_iun = '" . $column[0] . "' AND clicks_iun  = '" . $column[1] . "' AND pagini_iun  = '" . $column[2] . "' AND durata_iun  = '" . $column[3] . "' AND dispozitiv_iun  = '" . $column[4] . "' AND rezolutie_iun  = '" . $column[5] . "' AND locatie_iun  = '" . $column[6] . "'";
            ...
            if ($rowCheck['count'] == 0) {
                ...
                $sqlInsert = "Insert into iunie ( eveniment_iun , clicks_iun , pagini_iun , durata_iun , dispozitiv_iun , rezolutie_iun , locatie_iun ) values ('" . $column[0] . "', '" . $column[1] . "', '" . $column[2] . "', '" . $column[3] . "', '" . $column[4] . "', '" . $column[5] . "', '" . $column[6] . "')";
...
<body  id="iunie">>
    ...
    <!-- main -->
        <main>
            <h1 class="title">Timpul pe site al utilizatorilor în luna iunie</h1>
    ...
    // display upload data
        ...
        if(mysqli_num_rows($result)>0){
            ...
            <table>
                ...
                <tbody>
                    <tr>
                        <td class="narrow"><?php echo $row['nr_util_iun'];?></td>
                        <td class="narrow"><?php echo $row['eveniment_iun'];?></td>
                        <td class="narrow"><?php echo $row['clicks_iun'];?></td>
                        <td class="narrow"><?php echo $row['pagini_iun'];?></td>
                        <td class="narrow"><?php echo $row['durata_iun'];?></td>
                        <td class="narrow"><?php echo $row['dispozitiv_iun'];?></td>
                        <td class="narrow"><?php echo $row['rezolutie_iun'];?></td>
                        <td class="narrow"><?php echo $row['locatie_iun'];?></td>
                    </tr>
                </tbody>
        ...
        ?>
            ...
            <div id="custom-text-section">
                <h2>Interpretarea rezultatelor - Iunie</h2>
                <textarea id="custom-text-iunie" rows="4" cols="50"></textarea>
                <div class="btn-txt"> 
