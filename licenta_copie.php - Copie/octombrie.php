...
if(isset($_POST["import"])){
    ...
    if($_FILES["file"]["size"] > 0){
        ...
        while(($column = fgetcsv($file, 10000, ",")) !== FALSE){
            ...
            $sqlCheck = "SELECT COUNT(*) as count FROM octombrie WHERE eveniment_oct = '" . $column[0] . "' AND clicks_oct  = '" . $column[1] . "' AND pagini_oct  = '" . $column[2] . "' AND durata_oct  = '" . $column[3] . "' AND dispozitiv_oct  = '" . $column[4] . "' AND rezolutie_oct  = '" . $column[5] . "' AND locatie_oct  = '" . $column[6] . "'";
            ...
            if ($rowCheck['count'] == 0) {
                ...
                $sqlInsert = "Insert into octombrie ( eveniment_oct , clicks_oct , pagini_oct , durata_oct , dispozitiv_oct , rezolutie_oct , locatie_oct ) values ('" . $column[0] . "', '" . $column[1] . "', '" . $column[2] . "', '" . $column[3] . "', '" . $column[4] . "', '" . $column[5] . "', '" . $column[6] . "')";
...
<body id="octombrie">>
    ...
    <!-- main -->
        <main>
            <h1 class="title">Timpul pe site al utilizatorilor în luna octombrie</h1>
     ...
     <!-- content -->
        ...
        <?php
    // display upload data
        $sqlSelect = "SELECT * from octombrie";
        ...
        if(mysqli_num_rows($result)>0){
            ...
            <table>
                ...
                <tbody>
                    <tr>
                        <td class="narrow"><?php echo $row['nr_util_oct'];?></td>
                        <td class="narrow"><?php echo $row['eveniment_oct'];?></td>
                        <td class="narrow"><?php echo $row['clicks_oct'];?></td>
                        <td class="narrow"><?php echo $row['pagini_oct'];?></td>
                        <td class="narrow"><?php echo $row['durata_oct'];?></td>
                        <td class="narrow"><?php echo $row['dispozitiv_oct'];?></td>
                        <td class="narrow"><?php echo $row['rezolutie_oct'];?></td>
                        <td class="narrow"><?php echo $row['locatie_oct'];?></td>
                    </tr>
                </tbody>
        ...
        ?>
            ...
            <div id="custom-text-section">
                <h2>Interpretarea rezultatelor - Octombrie</h2>
                <textarea id="custom-text-octombrie" rows="4" cols="50"></textarea>
                <div class="btn-txt"> 
