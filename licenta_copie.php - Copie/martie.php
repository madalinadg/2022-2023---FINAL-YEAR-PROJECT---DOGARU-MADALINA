...
if(isset($_POST["import"])){
    ...
    if($_FILES["file"]["size"] > 0){
        ...
        while(($column = fgetcsv($file, 10000, ",")) !== FALSE){
            ...
            $sqlCheck = "SELECT COUNT(*) as count FROM martie WHERE eveniment_mar = '" . $column[0] . "' AND clicks_mar  = '" . $column[1] . "' AND pagini_mar  = '" . $column[2] . "' AND durata_mar  = '" . $column[3] . "' AND dispozitiv_mar  = '" . $column[4] . "' AND rezolutie_mar  = '" . $column[5] . "' AND locatie_mar  = '" . $column[6] . "'";
            ...
            if ($rowCheck['count'] == 0) {
                ...
                $sqlInsert = "Insert into martie ( eveniment_mar , clicks_mar , pagini_mar , durata_mar , dispozitiv_mar , rezolutie_mar , locatie_mar ) values ('" . $column[0] . "', '" . $column[1] . "', '" . $column[2] . "', '" . $column[3] . "', '" . $column[4] . "', '" . $column[5] . "', '" . $column[6] . "')";
...
<body id="martie">>
    ...
    <!-- main -->
        <main>
            <h1 class="title">Timpul pe site al utilizatorilor în luna martie</h1>
    ...
    // display upload data
        ...
        if(mysqli_num_rows($result)>0){
            ...
            <table>
                ...
                <tbody>
                    <tr>
                        <td class="narrow"><?php echo $row['nr_util_mar'];?></td>
                        <td class="narrow"><?php echo $row['eveniment_mar'];?></td>
                        <td class="narrow"><?php echo $row['clicks_mar'];?></td>
                        <td class="narrow"><?php echo $row['pagini_mar'];?></td>
                        <td class="narrow"><?php echo $row['durata_mar'];?></td>
                        <td class="narrow"><?php echo $row['dispozitiv_mar'];?></td>
                        <td class="narrow"><?php echo $row['rezolutie_mar'];?></td>
                        <td class="narrow"><?php echo $row['locatie_mar'];?></td>
                    </tr>
                </tbody>
        ...
        ?>
            ...
            <div id="custom-text-section">
                <h2>Interpretarea rezultatelor - Martie</h2>
                <textarea id="custom-text-martie" rows="4" cols="50"></textarea>
                <div class="btn-txt"> 
