...
if(isset($_POST["import"])){
    ...
    if($_FILES["file"]["size"] > 0){
        ...
        while(($column = fgetcsv($file, 10000, ",")) !== FALSE){
            ...
            $sqlCheck = "SELECT COUNT(*) as count FROM august WHERE eveniment_aug = '" . $column[0] . "' AND clicks_aug  = '" . $column[1] . "' AND pagini_aug  = '" . $column[2] . "' AND durata_aug  = '" . $column[3] . "' AND dispozitiv_aug  = '" . $column[4] . "' AND rezolutie_aug  = '" . $column[5] . "' AND locatie_aug  = '" . $column[6] . "'";
            ...
            if ($rowCheck['count'] == 0) {
                ...
                $sqlInsert = "Insert into august ( eveniment_aug , clicks_aug , pagini_aug , durata_aug , dispozitiv_aug , rezolutie_aug , locatie_aug ) values ('" . $column[0] . "', '" . $column[1] . "', '" . $column[2] . "', '" . $column[3] . "', '" . $column[4] . "', '" . $column[5] . "', '" . $column[6] . "')";
...
<body id="august">>
    ...
    <!-- main -->
        <main>
            <h1 class="title">Timpul pe site al utilizatorilor în luna august</h1>
    ...
    // display upload data
        ...
        if(mysqli_num_rows($result)>0){
            ...
            <table>
                ...
                <tbody>
                    <tr>
                        <td class="narrow"><?php echo $row['nr_util_aug'];?></td>
                        <td class="narrow"><?php echo $row['eveniment_aug'];?></td>
                        <td class="narrow"><?php echo $row['clicks_aug'];?></td>
                        <td class="narrow"><?php echo $row['pagini_aug'];?></td>
                        <td class="narrow"><?php echo $row['durata_aug'];?></td>
                        <td class="narrow"><?php echo $row['dispozitiv_aug'];?></td>
                        <td class="narrow"><?php echo $row['rezolutie_aug'];?></td>
                        <td class="narrow"><?php echo $row['locatie_aug'];?></td>
                    </tr>
                </tbody>
        ...
        ?>
                ...
                <div id="custom-text-section">
                    <h2>Interpretarea rezultatelor - August</h2>
                    <textarea id="custom-text-august" rows="4" cols="50"></textarea>
                    <div class="btn-txt"> 
