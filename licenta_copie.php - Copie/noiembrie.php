...
if(isset($_POST["import"])){
    ...
    if($_FILES["file"]["size"] > 0){
        ...
        while(($column = fgetcsv($file, 10000, ",")) !== FALSE){
            ...
            $sqlCheck = "SELECT COUNT(*) as count FROM noiembrie WHERE eveniment_noi = '" . $column[0] . "' AND clicks_noi  = '" . $column[1] . "' AND pagini_noi  = '" . $column[2] . "' AND durata_noi  = '" . $column[3] . "' AND dispozitiv_noi  = '" . $column[4] . "' AND rezolutie_noi  = '" . $column[5] . "' AND locatie_noi  = '" . $column[6] . "'";
            ...
            if ($rowCheck['count'] == 0) {
                ...
                $sqlInsert = "Insert into noiembrie ( eveniment_noi , clicks_noi , pagini_noi , durata_noi , dispozitiv_noi , rezolutie_noi , locatie_noi ) values ('" . $column[0] . "', '" . $column[1] . "', '" . $column[2] . "', '" . $column[3] . "', '" . $column[4] . "', '" . $column[5] . "', '" . $column[6] . "')";
...
<body id="noiembrie">>
    ...
    <!-- main -->
        <main>
            <h1 class="title">Timpul pe site al utilizatorilor în luna noiembrie</h1>
     ...
     <!-- content -->
        ...
        <?php
    // display upload data
        $sqlSelect = "SELECT * from noiembrie";
        ...
        if(mysqli_num_rows($result)>0){
            ...
            <table>
                ...
                <tbody>
                    <tr>
                        <td class="narrow"><?php echo $row['nr_util_noi'];?></td>
                        <td class="narrow"><?php echo $row['eveniment_noi'];?></td>
                        <td class="narrow"><?php echo $row['clicks_noi'];?></td>
                        <td class="narrow"><?php echo $row['pagini_noi'];?></td>
                        <td class="narrow"><?php echo $row['durata_noi'];?></td>
                        <td class="narrow"><?php echo $row['dispozitiv_noi'];?></td>
                        <td class="narrow"><?php echo $row['rezolutie_noi'];?></td>
                        <td class="narrow"><?php echo $row['locatie_noi'];?></td>
                    </tr>
                </tbody>
        ...
        ?>
            ...
            <div id="custom-text-section">
                <h2>Interpretarea rezultatelor - Noiembrie</h2>
                <textarea id="custom-text-noiembrie" rows="4" cols="50"></textarea>
                <div class="btn-txt"> 
