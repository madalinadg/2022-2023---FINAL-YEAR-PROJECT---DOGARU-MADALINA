...
if(isset($_POST["import"])){
    ...
    if($_FILES["file"]["size"] > 0){
        ...
        while(($column = fgetcsv($file, 10000, ",")) !== FALSE){
            ...
            $sqlCheck = "SELECT COUNT(*) as count FROM timp WHERE eveniment = '" . $column[0] . "' AND clicks = '" . $column[1] . "' AND pagini = '" . $column[2] . "' AND durata = '" . $column[3] . "' AND dispozitiv = '" . $column[4] . "' AND rezolutie = '" . $column[5] . "' AND locatie = '" . $column[6] . "'";
            ...
            if ($rowCheck['count'] == 0) {
                ...
                $sqlInsert = "Insert into timp ( eveniment, clicks, pagini, durata, dispozitiv, rezolutie, locatie) values ('" . $column[0] . "', '" . $column[1] . "', '" . $column[2] . "', '" . $column[3] . "', '" . $column[4] . "', '" . $column[5] . "', '" . $column[6] . "')";
...
<body id="aprilie">>
    ...
    <!-- main -->
        <main>
            <h1 class="title">Timpul pe site al utilizatorilor în luna aprilie</h1>
    ...
    // display upload data
        ...
        ?>
                ...
                <div id="custom-text-section">
                    <h2>Interpretarea rezultatelor - Aprilie</h2>
                    <textarea id="custom-text-aprilie" rows="4" cols="50"></textarea>
                    <div class="btn-txt"> 
